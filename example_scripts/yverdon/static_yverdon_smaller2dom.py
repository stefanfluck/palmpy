...
outpath = str(Path.home() / 'Desktop' / 'yverdon2dom_out')+'\\' #where the staticfile shall be saved
...
bulkvegclass2 = 3 #bulk classification of vegetation (PALM class. system). Is applied to cells without geodata classification

#LAD PARAMETERS CHILD 2
lai_forest2 = 10; lai_breihe2 = 10; lai_ebgebu2 = 10;
#a_forest2 = 2;   b_forest2 = 1.2 #shape parameters alpha and beta. run mst.showbetadistribution() for possible parameters
a_forest2 = 1.3;   b_forest2 = 1.1 #shape parameters alpha and beta. run mst.showbetadistribution() for possible parameters
a_breihe2 = 1.3; b_breihe2 = 1.1
#a_ebgebu2 = 4;   b_ebgebu2 = 2
a_ebgebu2 = 1.3;   b_ebgebu2 = 1.1
