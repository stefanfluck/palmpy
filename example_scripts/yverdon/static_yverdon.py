...
ax.imshow(img)
rect1 = patches.Rectangle((llx[1]/orthores,(ylen[0]-lly[1]-ylen[1])/orthores), 
                          xlen[1]/orthores,ylen[1]/orthores, 
                          linewidth=1, edgecolor='r', facecolor='none')
ax.add_patch(rect1)
rect2 = patches.Rectangle(((llx[2])/orthores,(ylen[0]-lly[2]-ylen[2])/orthores), 
                          xlen[2]/orthores,ylen[2]/orthores, 
                          linewidth=1, edgecolor='r', facecolor='none')
ax.add_patch(rect2)
plt.show()
