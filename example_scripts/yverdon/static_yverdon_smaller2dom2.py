...
outpath = str(Path.home() / 'Desktop' / 'yverdon2dom2_out')+'\\' #where the staticfile shall be saved
...
#parent
ischild0       =   0
xaus0,yaus0    =   3072.0, 3072.0                   # dimensions of domain in meter
xmin0,ymin0    =   poi2x-128-xaus0/2, poi2y-yaus0/2       # lower left corner (origin) coordinates
xmax0, ymax0   =   xmin0+xaus0, ymin0+yaus0         # calculation of upper right corner coords
zmax0          =   3072.0                           # vertical extent
xres0,yres0,zres0    =  16.0, 16.0, 16.0            # resolutions
...
lai_forest0 = 10; lai_breihe0 = 10; lai_ebgebu0 = 10;
#a_forest1 = 2;   b_forest1 = 1.2
a_forest0 = 1.3;   b_forest0 = 1.1
a_breihe0 = 1.3; b_breihe0 = 1.1
#a_ebgebu1 = 4;   b_ebgebu1 = 2
a_ebgebu0 = 1.3;   b_ebgebu0 = 1.1
...
##################### child 1 ###########################
ischild1       =   1
xaus1,yaus1    =   768.0, 384.0                   # dimensions of domain in meter
xmin1,ymin1    =   poi2x-128-xaus1/2, poi2y-64-yaus1/2       # lower left corner (origin) coordinates
xmax1, ymax1   =   xmin1+xaus1, ymin1+yaus1         # calculation of upper right corner coords
zmax1          =   96.0                            # vertical extent
xres1,yres1,zres1    =  2.0, 2.0, 2.0            # resolutions
...
#LAD PARAMETERS CHILD 1
lai_forest1 = 10; lai_breihe1 = 10; lai_ebgebu1 = 10;
#a_forest1 = 2;   b_forest1 = 1.2
a_forest1 = 1.3;   b_forest1 = 1.1
a_breihe1 = 1.3; b_breihe1 = 1.1
#a_ebgebu1 = 4;   b_ebgebu1 = 2
a_ebgebu1 = 1.3;   b_ebgebu1 = 1.1
